...
执行HotelDocumentTest 下的 testBulkRequest
...
![2022041815853](assets/2022041815853.jpg)



补全HotelSearchTest.java 中testSuggestion代码
...
如果数据乱码,重新拉取mysql docker ,执行以下命令
...
hotel-demo ，hotel-admin 下的application.yml中加入rabbitmq的配置信息

```
spring:
  datasource:
    url: jdbc:mysql://192.168.23.207:3306/els?useSSL=false
    username: root
    password: 123
...
打开浏览器观察rabbitmq中的队列信息   192.168.23.207:15672

60223

![20220418210219](assets/20220418210219.jpg)
